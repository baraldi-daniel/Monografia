...
for mensagem in consumidor:
    with open(r"C:\Users\baral\OneDrive\Documents\Engenharia de Dados - USP\Monografia\tempo-execução.txt", 'a') as f:
        end_counter = datetime.now()
        delta = (end_counter - start_counter).total_seconds()
        print("Tempo de Execução:"+str(delta)+'segundos\n')
        f.write("Tempo de Execução:"+str(delta)+'segundos\n')
        f.flush()
